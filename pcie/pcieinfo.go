...
func GetPCIeDevices() ([]PCIeDevice, error) {
	...
	for _, entry := range entries {
		...
		device.VendorName = vendorName(device.VendorID)
		device.DeviceName = deviceName(device.VendorID, device.DeviceID)
...
func PcieTabs() fyne.CanvasObject {
	...
	return container.NewAppTabs(
		...
		container.NewTabItem("Detail", container.NewScroll(pcieDetailLabel)),
	)
}
